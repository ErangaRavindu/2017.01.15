var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="index1.php" data-theme=view/layout/styles/layout.css"><img src="view/images/themes/default.jpg"/></a>'
            +'<a href="Ash.php"  data-theme="view/layout/styles/themes/Ash.css"><img src="view/images/themes/ash.jpg"/></a>'
            +'<a href="blue.php" data-theme="view/layout/styles/themes/blue.css""><img src="view/images/themes/blue.jpg"/></a>'
            +'<a href="index1.php" data-theme="css/theme-white.css"><img src="view/images/themes/light.jpg"/></a>'
            +'<a href="black.php" data-theme="view/layout/styles/themes/black.css"><img src="view/images/themes/black.jpg"/></a>'
        +'</div>'
...
function Redirect() {
    window.location="ash.php";
            }
    function setStyleSheet(url){
       var stylesheet = document.getElementById("data-theme");
