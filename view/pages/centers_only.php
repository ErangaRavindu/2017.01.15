...
<div class="nav1">
    ...
    <ul class="mainmenu">
        ...
        <li><span><a href="centers_only.php?type=update" id="menu">My Account</a></span></li>
        
       
	  	
     <li><span><a href="centers_only.php?type=center" id="menu">Center</a></span></li>
      ...
      <ul class="submenu" style="display: none;">
       ...
       <li><span><a href="centers_only.php?type=post">Add Post</a></span></li>
        <li><span><a href="centers_only.php?type=post1">View & Edit</a></span></li>
      </ul>
	  
	  
      
	  
		<li><span><a href="centers_only.php?type=reservation" id="menu">Reservation</a></span></li>
	...
	if(isset($_GET['type'])){
		if($_GET['type'] == 'update'){
			...
			require "generalinfo.php";
				...
				require "updatecenterdetails.php";
		}
				...
				require "centeraddpost.php";
		}
		else if($_GET['type'] == 'post1'){
				require "centerview_edit_post.php";
		}
		else if($_GET['type'] == 'reservation'){
				require "centerreservationinternal.php";
		}
