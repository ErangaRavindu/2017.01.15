...
<link rel="stylesheet" href="../layout/styles/style_forms.css">
		...
		//validating department form
		function testform(){
			if(document.departmentForm.DName.value==''){
				alert("Please enter your department Name");
				return false;
			}
			if(document.departmentForm.DLocation.value==''){
				alert("Please enter Location");
				return false;
			}
			if(document.departmentForm.DPhone.value==''){
				alert("Please enter Phone number");
				return false;
			}
			if(document.departmentForm.DFax.value==''){
				alert("Please enter Fax number");
				return false;
			}
			if(document.departmentForm.DHead.value==''){
				alert("Please enter head of department");
				return false;
			}
			if(document.departmentForm.email.value==''){
				alert("Please enter your email address");
				return false;
			}
			if(document.departmentForm.DWebsite.value==''){
				alert("Please enter url");
				return false;
			}
			return confirm("Do you want to register a new department");
		}

//validating fields in department form
    ...
    <body>
		...
		$count++; 
		$did = "D00" . strval($count);
                 
        ?> 
         
        
	<div class="forms1">    
	<form name="departmentForm" class="well form-horizontal" action="../../controller/department.php" method="post"  onsubmit="return testform()">
	<fieldset>
	<!-- Form Name -->
	<legend>ADD DEPARTMENT</legend>
            ...
            <label class="col-md-6 control-label">Department ID</label> 
				...
				<div class="input-group">
					...
					<input required class="form-control" type="text" name="id" value="<?php echo $did; ?>" readonly><br>
                </div>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
					 ...
					 <input required type="text" class="form-control name" placeholder="Department Name" name="DName" id="DName" onblur="validateDName(name)">
                </div>
