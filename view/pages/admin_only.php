...
<div class="nav1">
    ...
    <ul class="mainmenu">
        ...
        <li><span><a href="admin_only.php?type=update" id="menu" style="font-size: 1.2em;">My Account</a></span></li>
       

         
         <li><span><a href="admin_only.php?type=updateinfo" id="menu" style="font-size: 1.2em;">General Info</a></span></li>

       
      <li><span><a href="admin_only.php?type=stats" id="menu" style="font-size: 1.2em;">Statistics</a></span><div class="messages"></div></li>
	  
	  <li><span><a a="" href="#" id="menu" style="font-size: 1.2em;">Department</a></span></li>
        <ul class="submenu" style="display: none;">
		
		<li><span><a href="admin_only.php?type=dep" id="menu" >Add Department</a></span></li>

         
         <li><span><a href="admin_only.php?type=dep1" id="menu" >View & Edit</a></span></li>

        </ul>
		
		<li><span><a a="" href="#" id="menu" style="font-size: 1.2em;">Division</a></span></li>
        <ul class="submenu" style="display: none;">
		
		<li><span><a href="admin_only.php?type=divi" id="menu" >Add Division</a></span></li>

         
         <li><span><a href="admin_only.php?type=divi1" id="menu">View & Edit</a></span></li>

        </ul>
		
     <li><span><a href="#" id="menu" style="font-size: 1.2em;">Center</a></span></li>
        <ul class="submenu" style="display: none;">

         <li><span><a href="admin_only.php?type=center" >Add Center</a></span></li>
          <li><span><a href="admin_only.php?type=center1">View & Edit</a></span></li>
        </ul>

      <li><span><a href="#" id="menu" style="font-size: 1.2em;">Facility</a></span></li>
        <ul class="submenu" style="display: none;">

         <li><span><a href="admin_only.php?type=facility">Add Facility</a></span></li>
          <li><span><a href="admin_only.php?type=facility1">View & Edit</a></span></li>
        </ul>
      <li><span><a href="#" id="menu" style="font-size: 1.2em;">Course</a></span></li>

      <ul class="submenu" style="display: none;">

       <li><span><a href="admin_only.php?type=course">Add Course</a></span></li>
        <li><span><a href="admin_only.php?type=course1">View & Edit</a></span></li>
      </ul>
	  
	  <li><span><a href="#" id="menu" style="font-size: 1.2em;">Posts</a></span></li>

      <ul class="submenu" style="display: none;">

       <li><span><a href="admin_only.php?type=post">Add Post</a></span></li>
        <li><span><a href="admin_only.php?type=post1">View & Edit</a></span></li>
      </ul>
	  
	  
      
	  <li><span><a href="#" id="menu" style="font-size: 1.2em;">Achievement</a></span></li>
        <ul class="submenu" style="display: none;">

         <li><span><a href="admin_only.php?type=achievement">Add Achievement</a></span></li>
          <li><span><a href="admin_only.php?type=achievement1">View & Edit</a></span></li>
        </ul>
		
		<li><span><a href="admin_only.php?type=reservation" id="menu" style="font-size: 1.2em;">Reservation</a></span></li>
...
<?php
	if(isset($_GET['type'])){
		if($_GET['type'] == 'update'){
			require "updatestaffprofile.php";
		}
        ...
        <span class="close">&times;</span> Log <strong>Out</strong> ?</div>
         ...
         <div class="mb-footer">
             <div class="pull-right">
                 <a href="../../controller/logout.php" class="btn btn-success btn-lg">Confirm</a>
