	...
	<div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
		<div class="userid">
			<div class="sessionid">
						...
						<div style="padding-left: -150px; float:left; height: 60px; width: 60px; margin-top: -27px;">
							<?php
					...
					<div style="position: absolute; margin-top: -3px; margin-left: -50px;">
...
<div class="nav1">
    ...
    <ul class="mainmenu">
        ...
        <li><span><a href="staff_only.php?type=update" id="menu">My Account</a></span></li>
      ...
      <ul class="submenu" style="display: none;">
       ...
       <li><span><a href="staff_only.php?type=post">Add Post</a></span></li>
        <li><span><a href="staff_only.php?type=post1">View & Edit</a></span></li>
      </ul>
	  
	  
      
	  <li><span><a href="staff_only.php?type=reservation" id="menu">Reservation</a></span></li>
	...
	if(isset($_GET['type'])){
		if($_GET['type'] == 'update'){
			...
			require "generalinfo.php";
				...
				require "staffaddpost.php";
		}
		else if($_GET['type'] == 'post1'){
				require "staffview_edit_post.php";
		}
